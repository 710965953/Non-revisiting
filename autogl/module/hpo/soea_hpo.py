...
class SOEAOptimizer(BaseHPOptimizer): 
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.soea_method = kwargs.get("soea_method", "soea_DE_best_1_bin_templet")
    ...
    def optimize(self, trainer, dataset, time_limit=None, memory_limit=None, seed = 2021):
        ...
        if not os.path.exists("./soea_result"):
            os.mkdir("./soea_result")
        f = open("./soea_result/SOEAresult_{}.txt".format(time.strftime('%Y%m%d_%H%M')), mode='w')
